...
func (srv *GoodsService) GetGoodsPrice(c *gin.Context, id int) (int, error) {
	data, err := redigo.Int(resource.DefaultRedis.Do(c.Request.Context(), "GET", GOODS_PRICE_KEY+strconv.Itoa(id)))
	if err != nil {
...
func (srv *GoodsService) GetGoodsName(c *gin.Context, id int) (string, error) {
	data, err := redigo.String(resource.DefaultRedis.Do(c.Request.Context(), "GET", GOODS_NAME_KEY+strconv.Itoa(id)))
	if err != nil {
		err = errors.Wrap(err, "redis get goods price error：")
	}
	return data, err
...
func (srv *GoodsService) GetGoodsInfo(c *gin.Context, id int) map[string]interface{} {
	data, _ := redigo.String(resource.DefaultRedis.Do(c.Request.Context(), "GET", GOODS_NAME_KEY+strconv.Itoa(id)))
...
func (srv *GoodsService) BatchGoodsName(c *gin.Context, ids []int) []string {
	...
	data, _ := redigo.Strings(resource.DefaultRedis.Do(c.Request.Context(), "MGET", args...))
